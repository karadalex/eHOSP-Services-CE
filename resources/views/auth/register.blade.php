                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="full-width" name="gender">
    								<option value="null">Please Select Birth Gender</option>
                        ...
                        <div class="form-group{{ $errors->has('birth_country') ? ' has-error' : '' }}">
                            <label for="birth_country" class="col-md-4 control-label">Birth Country</label>

                            <div class="col-md-6">
                                <select class="full-width" name="birth_country">
                        ...
                        <div class="form-group{{ $errors->has('ssn') ? ' has-error' : '' }}">
                            <label for="ssn" class="col-md-4 control-label">Social Security Number</label>

                            <div class="col-md-6">
                                <input id="ssn" type="text" class="form-control" name="ssn" value="{{ old('ssn') }}">
