        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-0 col-md-4 col-md-offset-0 col-xl-3 col-xl-offset-0">
                            <a href="services/emergency" class="services" style="background-color: #ec5840"> @lang('services.Emergency') </a>
                        </div>
                        <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-0 col-md-4 col-md-offset-0 col-xl-3 col-xl-offset-0">
                            <a href="services/first-aid" class="services" style="background-color: #ec5840"> @lang('services.First Aid') </a>
                        </div>
                    </div>
                </div>
            </div>
