...
<?php
    ...
    ***************************************************************************/
    $CONFIG = array(
        // Application's Info
        'APP_NAME' => 'eHosp',
        'APP_HOSTNAME' => '192.168.1.6',
        'APP_PORT' => '8443',
        'APP_ROOT_PATH' => 'server/src/', // Leave blank if app's root path is the same with server's HTML root path
        ...
        'connect' => array(
            ...
            'facebook' => 'https://www.facebook.com/E-Hosp-279238362431959',
