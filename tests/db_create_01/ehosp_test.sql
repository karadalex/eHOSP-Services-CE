...
--
-- Host: localhost:3306
-- Generation Time: Apr 06, 2016 at 01:14 PM
...
INSERT INTO `user_registry` (`user_id`, `username`, `password`, `first_name`, `last_name`, `email`, `gender`, `user_type`, `age`, `birth_country`, `social_security_number`, `date`, `active`) VALUES
(1, 'username-test-1', 'eb9054711b5b7d9a018484609c53cb7e', 'first-name-test-1', 'last-name-test-1', 'test1@example.com', 'MALE', 'PATIENT', 18, 'GREECE', NULL, '2016-03-21 15:18:00', 0),
(2, 'username-test-2', 'password-test-2', 'first-name-test-2', 'last-name-test-2', 'test2@example.com', 'FEMALE', 'DOCTOR', 30, 'GREECE', NULL, '2016-03-28 00:00:00', 0),
(3, 'username-test-3', 'cd4023cf7807b3f8938352a61631e274', 'first-name-test-3', 'last-name-test-3', 'test3@example.com', 'MALE', 'DOCTOR', 30, 'GREECE', NULL, '2016-03-31 00:00:00', 0);
